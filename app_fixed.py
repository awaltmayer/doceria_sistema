...
# Configuração de chave secreta mais estável para produção
...
def init_db():
    """Inicializa a base de dados com dados padrão se necessário"""
    try:
        db.create_all()
        
        # Verifica se já existem trufas na base de dados
...
def obrigado(pedido_id):
    try:
        ...
        print(f"Erro na página de agradecimento: {e}")
...
def setup_database():
    try:
        ...
        return f"Erro ao configurar base de dados: {e}", 500
